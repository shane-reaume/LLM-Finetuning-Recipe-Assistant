...
def create_balanced_test_set(config, num_examples=100):
    """
...
def main():
    ...
    test_examples = create_balanced_test_set(config, num_examples=args.num_examples)
    ...
    print(f"Saved {len(test_examples)} balanced test examples to {output_path}")
